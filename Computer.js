/*
ChessBoard Interactive Frontend Program JS part 3
Written By: Kshitij Tomar
*/

/*
Uses the fetch API to send an HTTP POST request to your C++ server endpoint (/perform_move) whenever a move is made
*/
function performMove(move) 
{
    fetch('http://localhost:3000/perform_move', {
        method: 'POST',
        headers: {
